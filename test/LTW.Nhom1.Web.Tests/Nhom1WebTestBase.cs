...
using LTW.Nhom1.Models.TokenAuth;
...
{
    public abstract class Nhom1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Nhom1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Nhom1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Nhom1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Nhom1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Nhom1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Nhom1DbContext, Task<T>> func)
        {
            T result;
